...
class CerenkovBackground:
    """
    Calculate the Cherenkov background light generated by high-energy electrons
    in optical materials like silica or sapphire.

    This module computes the Cherenkov photon yield and angular distribution
    ...
    intensity : np.ndarray
        Cherenkov intensity spectrum [count/cm^2/s/sr/μm].
    n_array : np.ndarray
    ...
    .. plot::
    :caption: Cherenkov intensity vs. wavelength
    ...
    def evaluate(self):
        ...
        Ek, dEdX = get_electron_energy_loss(self.material, self.plot)
    ...
    def plot(self):
        ...
        plt.ylabel(r"Cherenkov Intensity [count/$cm^2$/s/sr/μm]")
        plt.title(r"Cherenkov Intensity vs. Wavelength")
        plt.grid(True)
        plt.show()
    ...
    def plot_cumulative_energy(self):
        ...
        plt.title("Cumulative Cherenkov Intensity and Angle vs. Energy")
        plt.legend()
        plt.show()
